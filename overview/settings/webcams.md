...
When using the HTML Iframe service, the aspect ratio controls the iframe sizing. The default is `16:9`. Use the format `WIDTH:HEIGHT` (also accepts `/`), for example `16:9`.

**Security note:** The iframe URL is user-supplied. Only embed sources you trust.
